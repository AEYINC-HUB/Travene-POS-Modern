...
public class SalesBalanceReport {
	...
	public void calculate() {
		...
		boolean priceIncludesTax = Application.getInstance().isPriceIncludesTax();
		
		if (!priceIncludesTax) {
			netSalesAmount = (grossTaxableSalesAmount + grossNonTaxableSalesAmount) - discountAmount;
		} else {
			netSalesAmount = (grossTaxableSalesAmount + grossNonTaxableSalesAmount) - (salesTaxAmount + discountAmount);
		}
